...
@section('content')
    <main class="py-14">
        <section class="container px-4 flex flex-col gap-5 items-center">
            ...
            <form action="{{ route('admin.katalog.store') }}" method="post" class="w-full max-w-[427px] flex flex-col gap-5"
                ...
                <div class="form-group flex flex-col gap-3">
                    ...
                    <select required class="input-field-2" name="kategori" id="kategori" placeholder="kategori">
